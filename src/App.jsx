...
const LIBRARY = {
  ...
  programs: [
    ...
    {lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128",    name:"Singapore Airlines KrisFlyer",    category:"Airline", points_currency:"KrisFlyer Miles",    inr_per_point:1.50, expiry_rule:"Miles expire after 36 months of account inactivity"},
    {lid:"lp_airindia", logo_url:"https://www.google.com/s2/favicons?domain=airindia.in&sz=128",     name:"Air India Flying Returns",         category:"Airline", points_currency:"Miles",              inr_per_point:0.70, expiry_rule:"Miles expire 36 months from date of earning"},
    {lid:"lp_united", logo_url:"https://www.google.com/s2/favicons?domain=united.com&sz=128",       name:"United MileagePlus",               category:"Airline", points_currency:"Miles",              inr_per_point:1.20, expiry_rule:"Miles never expire with account activity"},
    {lid:"lp_aeroplan", logo_url:"https://www.google.com/s2/favicons?domain=aircanada.com&sz=128",     name:"Air Canada Aeroplan",              category:"Airline", points_currency:"Points",             inr_per_point:1.40, expiry_rule:"Points expire after 18 months of inactivity"},
    {lid:"lp_turkish", logo_url:"https://www.google.com/s2/favicons?domain=turkishairlines.com&sz=128",      name:"Turkish Airlines Miles and Smiles", category:"Airline", points_currency:"Miles",              inr_per_point:1.00, expiry_rule:"Miles expire 3 years from date of earning"},
    {lid:"lp_thai", logo_url:"https://www.google.com/s2/favicons?domain=thaiairways.com&sz=128",         name:"Thai Airways Royal Orchid Plus",   category:"Airline", points_currency:"Miles",              inr_per_point:0.90, expiry_rule:"Miles expire 3 years from date of earning"},
    {lid:"lp_ethiopian", logo_url:"https://www.google.com/s2/favicons?domain=ethiopianairlines.com&sz=128",    name:"Ethiopian Airlines ShebaMiles",    category:"Airline", points_currency:"Miles",              inr_per_point:0.80, expiry_rule:"Miles expire 3 years from date of earning"},
    {lid:"lp_lifemiles", logo_url:"https://www.google.com/s2/favicons?domain=avianca.com&sz=128",    name:"Avianca LifeMiles",                category:"Airline", points_currency:"Miles",              inr_per_point:1.00, expiry_rule:"Miles expire after 12 months of inactivity"},
    {lid:"lp_ana", logo_url:"https://www.google.com/s2/favicons?domain=ana.co.jp&sz=128",          name:"ANA Mileage Club",                 category:"Airline", points_currency:"Miles",              inr_per_point:1.50, expiry_rule:"Miles expire 36 months from date of earning"},
    {lid:"lp_lufthansa", logo_url:"https://www.google.com/s2/favicons?domain=lufthansa.com&sz=128",    name:"Lufthansa Miles and More",         category:"Airline", points_currency:"Miles",              inr_per_point:1.00, expiry_rule:"Miles expire 36 months from date of earning. Covers SWISS, Austrian, Brussels Airlines"},
    // Airlines — Oneworld
    {lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",           name:"British Airways Executive Club",   category:"Airline", points_currency:"Avios",              inr_per_point:1.00, expiry_rule:"Avios expire after 36 months of inactivity"},
    {lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",        name:"Qatar Airways Privilege Club",     category:"Airline", points_currency:"Avios",              inr_per_point:1.30, expiry_rule:"Qmiles expire 3 years from date of earning"},
    {lid:"lp_finnair", logo_url:"https://www.google.com/s2/favicons?domain=finnair.com&sz=128",      name:"Finnair Plus",                     category:"Airline", points_currency:"Avios",              inr_per_point:1.00, expiry_rule:"Avios expire after 36 months of inactivity"},
    {lid:"lp_cathay", logo_url:"https://www.google.com/s2/favicons?domain=cathaypacific.com&sz=128",       name:"Cathay Pacific Asia Miles",        category:"Airline", points_currency:"Asia Miles",         inr_per_point:1.10, expiry_rule:"Miles expire 3 years from date of earning"},
    {lid:"lp_jal", logo_url:"https://www.google.com/s2/favicons?domain=jal.com&sz=128",          name:"Japan Airlines Mileage Bank",      category:"Airline", points_currency:"Miles",              inr_per_point:1.20, expiry_rule:"Miles expire 36 months from date of earning"},
    ...
    {lid:"lp_virgin", logo_url:"https://www.google.com/s2/favicons?domain=virginatlantic.com&sz=128",       name:"Virgin Atlantic Flying Club",      category:"Airline", points_currency:"Points",             inr_per_point:1.10, expiry_rule:"Points expire after 36 months of inactivity"},
    // Airlines — Independent
    {lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",       name:"Etihad Guest",                     category:"Airline", points_currency:"Miles",              inr_per_point:1.10, expiry_rule:"Miles expire after 18 months of inactivity"},
    {lid:"lp_spiceclub", logo_url:"https://www.google.com/s2/favicons?domain=spicejet.com&sz=128",    name:"SpiceJet SpiceClub",               category:"Airline", points_currency:"SpiceClub Miles",    inr_per_point:0.40, expiry_rule:"Miles expire 1 year from date of earning"},
    {lid:"lp_airasia", logo_url:"https://www.google.com/s2/favicons?domain=airasia.com&sz=128",      name:"AirAsia Rewards",                  category:"Airline", points_currency:"Points",             inr_per_point:0.30, expiry_rule:"Points expire after 12 months of inactivity"},
    {lid:"lp_lotusmiles", logo_url:"https://www.google.com/s2/favicons?domain=lotushotels.com&sz=128",   name:"Vietnam Airlines LotusMiles",      category:"Airline", points_currency:"Miles",              inr_per_point:0.60, expiry_rule:"Miles expire 3 years from date of earning"},
    // Hotels
    {lid:"lp_marriott", logo_url:"https://www.google.com/s2/favicons?domain=marriott.com&sz=128",     name:"Marriott Bonvoy",                  category:"Hotel",   points_currency:"Points",             inr_per_point:0.50, expiry_rule:"Points expire after 24 months of inactivity"},
    {lid:"lp_ihg", logo_url:"https://www.google.com/s2/favicons?domain=ihg.com&sz=128",          name:"IHG One Rewards",                  category:"Hotel",   points_currency:"Points",             inr_per_point:0.40, expiry_rule:"Points expire after 12 months of inactivity"},
    {lid:"lp_clubitc", logo_url:"https://www.google.com/s2/favicons?domain=itchotels.com&sz=128",      name:"Club ITC Green Points",            category:"Hotel",   points_currency:"Green Points",       inr_per_point:1.00, expiry_rule:"Points valid for 3 years from date of earning"},
    {lid:"lp_accor", logo_url:"https://www.google.com/s2/favicons?domain=accor.com&sz=128",        name:"Accor Live Limitless",             category:"Hotel",   points_currency:"Points",             inr_per_point:1.60, expiry_rule:"Points expire after 12 months of inactivity"},
    {lid:"lp_radisson", logo_url:"https://www.google.com/s2/favicons?domain=radissonhotels.com&sz=128",     name:"Radisson Rewards",                 category:"Hotel",   points_currency:"Points",             inr_per_point:0.35, expiry_rule:"Points expire after 12 months of inactivity"},
    {lid:"lp_wyndham", logo_url:"https://www.google.com/s2/favicons?domain=wyndhamhotels.com&sz=128",      name:"Wyndham Rewards",                  category:"Hotel",   points_currency:"Points",             inr_per_point:0.45, expiry_rule:"Points expire after 18 months of inactivity"},
    {lid:"lp_hilton", logo_url:"https://www.google.com/s2/favicons?domain=hilton.com&sz=128",       name:"Hilton Honors",                    category:"Hotel",   points_currency:"Points",             inr_per_point:0.30, expiry_rule:"Points expire after 12 months of inactivity"},
  ],

  // ── Credit Cards ─────────────────────────────────────────────────────────
  cards: [
    {
      lid:"cc_infinia", logo_url:"https://www.google.com/s2/favicons?domain=hdfcbank.com&sz=128",
      ...
      partners:[
        {to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128",  ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant–2 days", notes:""},
        {to_lid:"lp_airindia", logo_url:"https://www.google.com/s2/favicons?domain=airindia.in&sz=128",   ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Few hours",      notes:""},
        {to_lid:"lp_flyingblue", logo_url:"https://www.google.com/s2/favicons?domain=airfrance.com&sz=128", ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_iberia", logo_url:"https://www.google.com/s2/favicons?domain=iberia.com&sz=128",     ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",      ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",     ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_turkish", logo_url:"https://www.google.com/s2/favicons?domain=turkishairlines.com&sz=128",    ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_united", logo_url:"https://www.google.com/s2/favicons?domain=united.com&sz=128",     ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_aeroplan", logo_url:"https://www.google.com/s2/favicons?domain=aircanada.com&sz=128",   ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_spiceclub", logo_url:"https://www.google.com/s2/favicons?domain=spicejet.com&sz=128",  ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_airasia", logo_url:"https://www.google.com/s2/favicons?domain=airasia.com&sz=128",    ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_finnair", logo_url:"https://www.google.com/s2/favicons?domain=finnair.com&sz=128",    ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_lifemiles", logo_url:"https://www.google.com/s2/favicons?domain=avianca.com&sz=128",  ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_lotusmiles", logo_url:"https://www.google.com/s2/favicons?domain=lotushotels.com&sz=128", ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_thai", logo_url:"https://www.google.com/s2/favicons?domain=thaiairways.com&sz=128",       ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_cathay", logo_url:"https://www.google.com/s2/favicons?domain=cathaypacific.com&sz=128",     ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_marriott", logo_url:"https://www.google.com/s2/favicons?domain=marriott.com&sz=128",   ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_ihg", logo_url:"https://www.google.com/s2/favicons?domain=ihg.com&sz=128",        ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_clubitc", logo_url:"https://www.google.com/s2/favicons?domain=itchotels.com&sz=128",    ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_accor", logo_url:"https://www.google.com/s2/favicons?domain=accor.com&sz=128",      ratio_from:2, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_radisson", logo_url:"https://www.google.com/s2/favicons?domain=radissonhotels.com&sz=128",   ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
        {to_lid:"lp_wyndham", logo_url:"https://www.google.com/s2/favicons?domain=wyndhamhotels.com&sz=128",    ratio_from:1, ratio_to:1, min_transfer:500,  transfer_time:"Instant",        notes:""},
      ],
    },
    {
      lid:"cc_bizblack", logo_url:"https://www.google.com/s2/favicons?domain=hdfcbank.com&sz=128",
      ...
      partners:[
        {to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128", ratio_from:1, ratio_to:1, min_transfer:500, transfer_time:"Instant–2 days", notes:"Only transfer partner for Biz Black"},
      ],
    },
    {
      lid:"cc_marriotthdfc", logo_url:"https://www.google.com/s2/favicons?domain=marriott.com&sz=128",
    ...
    {
      lid:"cc_magnusburgundy", logo_url:"https://www.google.com/s2/favicons?domain=axisbank.com&sz=128",
      ...
      partners:[
        ...
        {to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128",  ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",      ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",     ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_jal", logo_url:"https://www.google.com/s2/favicons?domain=jal.com&sz=128",        ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_aeroplan", logo_url:"https://www.google.com/s2/favicons?domain=aircanada.com&sz=128",   ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_united", logo_url:"https://www.google.com/s2/favicons?domain=united.com&sz=128",     ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_turkish", logo_url:"https://www.google.com/s2/favicons?domain=turkishairlines.com&sz=128",    ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_thai", logo_url:"https://www.google.com/s2/favicons?domain=thaiairways.com&sz=128",       ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_ethiopian", logo_url:"https://www.google.com/s2/favicons?domain=ethiopianairlines.com&sz=128",  ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:5, ratio_to:2, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_finnair", logo_url:"https://www.google.com/s2/favicons?domain=finnair.com&sz=128",    ratio_from:5, ratio_to:2, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_lotusmiles", logo_url:"https://www.google.com/s2/favicons?domain=lotushotels.com&sz=128", ratio_from:5, ratio_to:2, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_ana", logo_url:"https://www.google.com/s2/favicons?domain=ana.co.jp&sz=128",        ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        {to_lid:"lp_wyndham", logo_url:"https://www.google.com/s2/favicons?domain=wyndhamhotels.com&sz=128",    ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group A — cap 2L pts/yr"},
        // Group B — annual cap 8L EDGE pts/year
        {to_lid:"lp_airindia", logo_url:"https://www.google.com/s2/favicons?domain=airindia.in&sz=128",   ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group B — cap 8L pts/yr"},
        {to_lid:"lp_flyingblue", logo_url:"https://www.google.com/s2/favicons?domain=airfrance.com&sz=128", ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group B — cap 8L pts/yr"},
        {to_lid:"lp_qantas", logo_url:"https://www.google.com/s2/favicons?domain=qantas.com&sz=128",     ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group B — cap 8L pts/yr"},
        {to_lid:"lp_spiceclub", logo_url:"https://www.google.com/s2/favicons?domain=spicejet.com&sz=128",  ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group B — cap 8L pts/yr"},
        {to_lid:"lp_airasia", logo_url:"https://www.google.com/s2/favicons?domain=airasia.com&sz=128",    ratio_from:5, ratio_to:4, min_transfer:300, transfer_time:"Instant", notes:"Group B — cap 8L pts/yr"},
      ],
    },
    {
      lid:"cc_atlas", logo_url:"https://www.google.com/s2/favicons?domain=axisbank.com&sz=128",
      ...
      partners:[
        ...
        {to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128",  ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",     ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_turkish", logo_url:"https://www.google.com/s2/favicons?domain=turkishairlines.com&sz=128",    ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_united", logo_url:"https://www.google.com/s2/favicons?domain=united.com&sz=128",     ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_jal", logo_url:"https://www.google.com/s2/favicons?domain=jal.com&sz=128",        ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_thai", logo_url:"https://www.google.com/s2/favicons?domain=thaiairways.com&sz=128",       ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_finnair", logo_url:"https://www.google.com/s2/favicons?domain=finnair.com&sz=128",    ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_ethiopian", logo_url:"https://www.google.com/s2/favicons?domain=ethiopianairlines.com&sz=128",  ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_lotusmiles", logo_url:"https://www.google.com/s2/favicons?domain=lotushotels.com&sz=128", ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        {to_lid:"lp_ana", logo_url:"https://www.google.com/s2/favicons?domain=ana.co.jp&sz=128",        ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group A — cap 30K miles/yr"},
        // Group B — annual cap 120K EDGE miles/year
        {to_lid:"lp_airindia", logo_url:"https://www.google.com/s2/favicons?domain=airindia.in&sz=128",   ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_flyingblue", logo_url:"https://www.google.com/s2/favicons?domain=airfrance.com&sz=128", ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_aeroplan", logo_url:"https://www.google.com/s2/favicons?domain=aircanada.com&sz=128",   ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_qantas", logo_url:"https://www.google.com/s2/favicons?domain=qantas.com&sz=128",     ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_spiceclub", logo_url:"https://www.google.com/s2/favicons?domain=spicejet.com&sz=128",  ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_airasia", logo_url:"https://www.google.com/s2/favicons?domain=airasia.com&sz=128",    ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_marriott", logo_url:"https://www.google.com/s2/favicons?domain=marriott.com&sz=128",   ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_accor", logo_url:"https://www.google.com/s2/favicons?domain=accor.com&sz=128",      ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_ihg", logo_url:"https://www.google.com/s2/favicons?domain=ihg.com&sz=128",        ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_clubitc", logo_url:"https://www.google.com/s2/favicons?domain=itchotels.com&sz=128",    ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
        {to_lid:"lp_wyndham", logo_url:"https://www.google.com/s2/favicons?domain=wyndhamhotels.com&sz=128",    ratio_from:1, ratio_to:2, min_transfer:500, transfer_time:"Instant", notes:"Group B — cap 120K miles/yr"},
      ],
    },
    {
      lid:"cc_mrcc", logo_url:"https://www.google.com/s2/favicons?domain=americanexpress.com&sz=128",
      ...
      partners:[
        {to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128", ratio_from:2, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 2:1 ratio"},
        {to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",        ratio_from:2, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 2:1 ratio"},
        {to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",     ratio_from:2, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 2:1 ratio"},
        {to_lid:"lp_cathay", logo_url:"https://www.google.com/s2/favicons?domain=cathaypacific.com&sz=128",    ratio_from:2, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 2:1 ratio"},
        {to_lid:"lp_virgin", logo_url:"https://www.google.com/s2/favicons?domain=virginatlantic.com&sz=128",    ratio_from:2, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 2:1 ratio"},
        {to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",    ratio_from:2, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 2:1 ratio. Partnership ends June 2026"},
        {to_lid:"lp_marriott", logo_url:"https://www.google.com/s2/favicons?domain=marriott.com&sz=128",  ratio_from:1, ratio_to:1, min_transfer:1000, transfer_time:"Instant",       notes:"Indian Amex — 1:1 ratio"},
        {to_lid:"lp_hilton", logo_url:"https://www.google.com/s2/favicons?domain=hilton.com&sz=128",    ratio_from:1, ratio_to:0.9,min_transfer:1000,transfer_time:"Instant",       notes:"Indian Amex — 1,000 pts = 900 Hilton points"},
      ],
    },
    {
  ...
  lp_partners:[
    ...
    {from_lid:"lp_marriott", to_lid:"lp_airindia", logo_url:"https://www.google.com/s2/favicons?domain=airindia.in&sz=128",   ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128",  ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_flyingblue", logo_url:"https://www.google.com/s2/favicons?domain=airfrance.com&sz=128", ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus Avios per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_iberia", logo_url:"https://www.google.com/s2/favicons?domain=iberia.com&sz=128",     ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus Avios per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_aerlingus", logo_url:"https://www.google.com/s2/favicons?domain=aerlingus.com&sz=128",  ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus Avios per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",      ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus Avios per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",     ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_turkish", logo_url:"https://www.google.com/s2/favicons?domain=turkishairlines.com&sz=128",    ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_cathay", logo_url:"https://www.google.com/s2/favicons?domain=cathaypacific.com&sz=128",     ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_jal", logo_url:"https://www.google.com/s2/favicons?domain=jal.com&sz=128",        ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_qantas", logo_url:"https://www.google.com/s2/favicons?domain=qantas.com&sz=128",     ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    ...
    {from_lid:"lp_marriott", to_lid:"lp_spiceclub", logo_url:"https://www.google.com/s2/favicons?domain=spicejet.com&sz=128",  ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_ethiopian", logo_url:"https://www.google.com/s2/favicons?domain=ethiopianairlines.com&sz=128",  ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_lotusmiles", logo_url:"https://www.google.com/s2/favicons?domain=lotushotels.com&sz=128", ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_thai", logo_url:"https://www.google.com/s2/favicons?domain=thaiairways.com&sz=128",       ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},
    {from_lid:"lp_marriott", to_lid:"lp_virgin", logo_url:"https://www.google.com/s2/favicons?domain=virginatlantic.com&sz=128",     ratio_from:3, ratio_to:1, min_transfer:3000, transfer_time:"3–7 days",  notes:"+5,000 bonus miles per 60,000 pts transferred"},

    // ── Accor Live Limitless → Airlines ──────────────────────────────────────
    {from_lid:"lp_accor",    to_lid:"lp_flyingblue", logo_url:"https://www.google.com/s2/favicons?domain=airfrance.com&sz=128", ratio_from:1, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:"Best ratio — only 1:1 partner"},
    {from_lid:"lp_accor",    to_lid:"lp_qantas", logo_url:"https://www.google.com/s2/favicons?domain=qantas.com&sz=128",     ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},
    {from_lid:"lp_accor",    to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},
    {from_lid:"lp_accor",    to_lid:"lp_iberia", logo_url:"https://www.google.com/s2/favicons?domain=iberia.com&sz=128",     ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},
    {from_lid:"lp_accor",    to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",      ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},
    {from_lid:"lp_accor",    to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",     ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},
    {from_lid:"lp_accor",    to_lid:"lp_aeroplan", logo_url:"https://www.google.com/s2/favicons?domain=aircanada.com&sz=128",   ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},
    {from_lid:"lp_accor",    to_lid:"lp_united", logo_url:"https://www.google.com/s2/favicons?domain=united.com&sz=128",     ratio_from:2, ratio_to:1, min_transfer:2000, transfer_time:"Instant",   notes:""},

    // ── IHG One Rewards → Airlines (all 5:1) ─────────────────────────────────
    {from_lid:"lp_ihg",      to_lid:"lp_airindia", logo_url:"https://www.google.com/s2/favicons?domain=airindia.in&sz=128",   ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only — call IHG Service Centre"},
    {from_lid:"lp_ihg",      to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_krisflyer", logo_url:"https://www.google.com/s2/favicons?domain=singaporeair.com&sz=128",  ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_flyingblue", logo_url:"https://www.google.com/s2/favicons?domain=airfrance.com&sz=128", ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_united", logo_url:"https://www.google.com/s2/favicons?domain=united.com&sz=128",     ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_etihad", logo_url:"https://www.google.com/s2/favicons?domain=etihad.com&sz=128",     ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",      ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_turkish", logo_url:"https://www.google.com/s2/favicons?domain=turkishairlines.com&sz=128",    ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},
    {from_lid:"lp_ihg",      to_lid:"lp_aeroplan", logo_url:"https://www.google.com/s2/favicons?domain=aircanada.com&sz=128",   ratio_from:5, ratio_to:1, min_transfer:10000, transfer_time:"4–6 weeks", notes:"Transfer via phone only"},

    // ── Avios LP→LP (BA as hub — all 1:1, instant, free) ─────────────────────
    {from_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",       to_lid:"lp_qatar", logo_url:"https://www.google.com/s2/favicons?domain=qatarairways.com&sz=128",      ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com — BA is Avios hub"},
    {from_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",       to_lid:"lp_iberia", logo_url:"https://www.google.com/s2/favicons?domain=iberia.com&sz=128",     ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com"},
    {from_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",       to_lid:"lp_finnair", logo_url:"https://www.google.com/s2/favicons?domain=finnair.com&sz=128",    ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com"},
    {from_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",       to_lid:"lp_aerlingus", logo_url:"https://www.google.com/s2/favicons?domain=aerlingus.com&sz=128",  ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com"},
    {from_lid:"lp_qatar",    to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com — routes via BA"},
    {from_lid:"lp_iberia",   to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com"},
    {from_lid:"lp_finnair",  to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com — routes via BA"},
    {from_lid:"lp_aerlingus",to_lid:"lp_ba", logo_url:"https://www.google.com/s2/favicons?domain=britishairways.com&sz=128",         ratio_from:1, ratio_to:1, min_transfer:1,    transfer_time:"Instant",   notes:"Free transfer via avios.com"},
  ],
};
...
function LogoCircle({url,name,size=40}){
  ...
  if(url&&url.length>10&&!err) return(
    <div style={{width:size,height:size,borderRadius:size*0.22,overflow:"hidden",flexShrink:0,background:"#ffffff"}}>
      <img src={url} alt={name||""} style={{width:"100%",height:"100%",objectFit:"contain",padding:size*0.08,display:"block"}} onError={()=>setErr(true)}/>
    </div>
  );
  return(
    <div style={{width:size,height:size,borderRadius:size*0.22,background:acc+"18",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
