                ...
                return(
                  <div key={lib.lid} style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,padding:"12px 14px",background:surf2,borderRadius:10,border:`1px solid ${bdr}`}}>
                    ...
                    {already
                      ...
                      :<button
                          style={{...pbtn,fontSize:12,padding:"5px 14px",opacity:importing===lib.lid?0.5:1}}
                          onClick={()=>importFromLibrary(lib)}
                          disabled={!!importing}
                        >{importing===lib.lid?"Importing…":"Import"}</button>
                    }
                  </div>
                );
              })}
                  ...
                  <div style={{flex:1}}>
                    {editId===m.id?(
                      <div style={{display:"flex",gap:8,alignItems:"center"}}>
                        <input style={{...inp,flex:1,marginBottom:0,fontSize:13}} value={editName}
